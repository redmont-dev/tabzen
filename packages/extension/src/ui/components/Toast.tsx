...
interface ToastMessage { text: string; id: number; }
let showToastFn: ((text: string) => void) | null = null;

export function showToast(text: string) { showToastFn?.(text); }
...
export function ToastContainer() {
  ...
  return <div key={toast.id} class={styles.toast}>{toast.text}</div>;
}
